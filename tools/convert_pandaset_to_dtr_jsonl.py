...
今回の版では、pandaset-devkit の seq.cuboids[frame_idx] は使わず、
annotations/cuboids/00.pkl などを pandas.read_pickle() で直接読みます。
"""
...
def cuboids_to_objects(
    ...
    for _, row in df.iterrows():
        ...
        if bbox_area_xyxy(bbox) < min_area_norm1000:
            skip_counter["skip_small_area"] += 1
            continue
...
def main() -> None:
    ...
    parser.add_argument("--min_area_norm1000", type=float, default=20.0)
